        ...
        public override void Play()
        {
            ...
            foreach (Player player in Players)
            {
                ...
                while (!validAnswer)
                {
                    ...
                    if (!validAnswer) Console.WriteLine("Please enter the amount in digits, no decimals");
                }
               if (bet < 0 )
                {
            ...
            foreach (Player player in Players)
            {
                while (!player.Stay)
                {
                    ...
                    if (busted)
                    {
                        ...
                        Console.WriteLine("Do you want to play again?Please answer a yes or no");
            ...
            foreach (Player player in Players)
            {
                ...
                Console.WriteLine("Play again?Please answer a yes or no");
                string answer = Console.ReadLine().ToLower();
                if (answer == "yes")
                {
                    player.IsActivelyPlaying = true;
